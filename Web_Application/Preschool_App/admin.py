...
class RequestAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Request_Name', 'Request_Status')
...
class ParentAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Parent_Full_Name', 'Parent_Phone_Number')
...
class PreschoolerAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Preschooler_Full_Name', 'Admission_Date', 'Departure_Date', 'Preschooler_Status',
                    'Birth_Certificate_Series', 'Birth_Certificate_Number', 'Date_Of_Birth', 'Preschooler_Gender', 'Registered_Address', 'Residential_Address')
...
class EducationContractAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Contract_Date', 'Contract_Place', 'Performer', 'Contract_Status')
...
class ParentsAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Parent_Code', 'Party_Name')
...
class MedicalRecordAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Healthcare_Institution_Name', 'Medical_Record_Creation_Date', 'Obligatory_Medical_Insurance_Number', 'Medical_Record_Number')
...
class MedicalRecordEntryAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Doctor_Full_Name', 'Department', 'Date', 'Entry_Type', 'Diagnosis', 'Treatment_Stage', 'Note')
...
class GroupAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Group_Name', 'Group_Formation_Date', 'Number_Of_Preschoolers')
...
class AttendanceAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Presence', 'Note', 'Date')
...
class LessonAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Lesson_Start_Datetime', 'Lesson_End_Datetime', 'Lesson_Title', 'Room')
...
class TeacherAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Employee_Code', 'Teacher_Specialization')
...
class EmployeeAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Employee_Full_Name', 'Employee_Date_Of_Birth', 'Department', 'Employee_Position', 'Employee_Passport_Series',
                    'Employee_Passport_Number', 'Employee_TIN', 'Employee_PIPN', 'Employee_Email', 'Employee_Account_Number', 'Employee_Bank_Details', 'Employee_Registration_Address',
                    'Employee_Residential_Address', 'Employee_Salary')
...
class EducationDocumentAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Document_Type', 'Educational_Institution_Name', 'Issue_Date', 'Degree',
                    'Qualification', 'Education_Document_Series', 'Education_Document_Number', 'Registration_Number')
...
class PersonalMedicalBookAdmin(admin.ModelAdmin):
    ...
    search_fields = ('Medical_Book_Number', 'Issuing_Place', 'Issue_Date')
